...
const auPairCountries = [
  ...
  },
  {
    ...
    cost: "~670 AUD",
    description: "Kombinera au pair med det australiska äventyret. Upplev surfkultur, vilda djur och en avslappnad livsstil medan du bor hos en australisk familj. Genomsnittlig fickpeng är högst i världen för au pairs.",

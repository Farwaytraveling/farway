...
const destinations = [
  ...
  },
  {
    ...
    flag: "🇦🇹",
    programs: 42,
    popular: "St. Anton, Ischgl, Kitzbühel",
  ...
  },
  {
    ...
    flag: "🇨🇭",
    programs: 38,
    popular: "Zermatt, Verbier, St. Moritz",
    image: "https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=600&h=400&fit=crop",
  },
  {
    country: "Frankrike (Alperna)",
    flag: "🇫🇷",
    programs: 40,
    popular: "Val d'Isère, Chamonix, Courchevel",
    image: "https://images.unsplash.com/photo-1548777123-e216912df7d8?w=600&h=400&fit=crop",
  },
  {
    country: "Italien (Dolomterna)",
    flag: "🇮🇹",
    programs: 35,
    popular: "Val Gardena, Cortina, Livigno",
  ...
  },
  {
    ...
    flag: "🇦🇩",
    programs: 22,
    popular: "Grandvalira, Vallnord, Soldeu",

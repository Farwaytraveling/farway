...
export const resortDetails: Record<string, ResortDetail> = {
  ...
  "Grandvalira": {
    ...
    country: "Andorra",
    flag: "🇦🇩",
    vibe: "Skattefritt & soligt",
    description:
      "Pyrenéernas största skidområde med 210 km pist över sex sammanlänkade orter (Pas de la Casa, Soldeu, El Tarter m.fl.). Skattefri shopping och 300 soldagar/år.",
    bestFor: ["Budgetsäsongare", "Spansk- & franskkunniga", "Soldagar"],
    season: "Början dec – mitten apr",
    altitude: "1 710 – 2 640 m",
    skiArea: "210 km pist (Grandvalira)",
    liftPassPrice: "€57/dag · ca €600/säsong",
    nearestAirport: "Barcelona (3h) · Toulouse (3h) · Andorra-La Seu (45 min)",
    jobs: [
      { type: "Skidskola & liftvärd", salary: "€1 200–1 600/mån + boende", tip: "Grandvalira anställer 200+ varje säsong – ansök från september." },
      { type: "Hotell & restaurang", salary: "€1 100–1 500/mån + boende", tip: "Pas de la Casa har mest brittiska/svenska säsongsjobb." },
    ],
    housing: { tip: "Personalboende via arbetsgivare standard – privat hyra ovanligt under säsong.", priceRange: "€450–800/mån privat" },
    facebookGroups: [
      { name: "Grandvalira Seasonaires", url: "https://www.facebook.com/groups/grandvaliraseasonaires/" },
      { name: "Andorra Jobs & Housing", url: "https://www.facebook.com/groups/andorrajobs/" },
    ],
    jobLinks: [
      { name: "Grandvalira karriär", url: "https://www.grandvalira.com/en/work-grandvalira" },
      { name: "Andorra Treball", url: "https://www.treball.ad/" },
    ],
    officialLinks: [
      { name: "Officiell sida Grandvalira", url: "https://www.grandvalira.com/en" },
      { name: "Pistkarta", url: "https://www.grandvalira.com/en/ski-area/slopes-lifts" },
      { name: "Snö- & väderrapport", url: "https://www.grandvalira.com/en/ski-area/snow-report" },
      { name: "Liftkort online", url: "https://shop.grandvalira.com/" },
    ],
    travelLinks: [
      { name: "Andbus (Barcelona/Toulouse → Andorra)", url: "https://www.andorrabybus.com/" },
      { name: "Direct Bus Barcelona", url: "https://www.directbus.es/en/" },
    ],
    swedishTip: "Andorra är inte EU – du behöver arbetstillstånd som arbetsgivaren ordnar. Räkna med 2–3 veckors processtid.",
    checklist: [
      "Pass (giltigt min 6 mån)",
      "Arbetstillstånd (ordnas av arbetsgivaren)",
      "Hälsointyg från svensk läkare",
      "Privat sjukförsäkring (CASS-kortet ges efter registrering)",
      "Spanska eller franska CV",
    ],
  },
  "Vallnord": {
    name: "Vallnord",
    country: "Andorra",
    flag: "🇦🇩",
    vibe: "Lugnare & familjevänligt",
    description:
      "Andorras andra stora skidområde (Pal-Arinsal + Ordino-Arcalís). Mindre än Grandvalira men mer autentiskt och lugnt – perfekt för dig som vill ha vacker natur utan turistmassorna.",
    bestFor: ["Lugnare alternativ", "Familjehotell", "Naturupplevelser"],
    season: "Början dec – mitten apr",
    altitude: "1 550 – 2 625 m",
    skiArea: "93 km pist (Pal-Arinsal & Ordino-Arcalís)",
    liftPassPrice: "€48/dag · ca €540/säsong",
    nearestAirport: "Barcelona (3h) · Toulouse (3h)",
    jobs: [
      { type: "Liftpersonal & uthyrning", salary: "€1 100–1 500/mån + boende", tip: "Vallnord anställer säsong från oktober – mindre konkurrens än Grandvalira." },
      { type: "Hotell & restaurang", salary: "€1 100–1 500/mån + boende", tip: "Arinsal har de flesta brittiska säsongare och après-ski." },
    ],
    housing: { tip: "Personalboende via arbetsgivare. La Massana (5 min nedanför) har bättre privat hyresmarknad.", priceRange: "€450–750/mån privat" },
    facebookGroups: [
      { name: "Vallnord / Arinsal Seasonaires", url: "https://www.facebook.com/groups/arinsalseasonaires/" },
      { name: "Andorra Jobs & Housing", url: "https://www.facebook.com/groups/andorrajobs/" },
    ],
    jobLinks: [
      { name: "Pal-Arinsal karriär", url: "https://www.palarinsal.com/en/work-with-us" },
      { name: "Andorra Treball", url: "https://www.treball.ad/" },
    ],
    officialLinks: [
      { name: "Officiell sida Pal-Arinsal", url: "https://www.palarinsal.com/en" },
      { name: "Officiell sida Ordino-Arcalís", url: "https://www.ordinoarcalis.com/en" },
      { name: "Pistkarta & snörapport", url: "https://www.palarinsal.com/en/winter/slopes-lifts" },
      { name: "Liftkort online", url: "https://shop.palarinsal.com/" },
    ],
    travelLinks: [
      { name: "Andbus (Barcelona/Toulouse → Andorra)", url: "https://www.andorrabybus.com/" },
      { name: "Lokalbuss → Pal/Arinsal/Ordino", url: "https://www.mobilitat.ad/" },
    ],
    swedishTip: "Arinsal har den största brittiska/skandinaviska säsongssceneriet – Surf 'n' Turf och Quo Vadis är samlingsplatserna.",
    checklist: [
      "Pass (giltigt min 6 mån)",
      "Arbetstillstånd (ordnas av arbetsgivaren)",
      "Hälsointyg från svensk läkare",
      "Privat sjukförsäkring (CASS-kortet ges efter registrering)",
      "Engelsk CV räcker för Arinsal-pubarna",
    ],
  },
};
